document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        en: {
            ...
            service_japanese_desc: "Traditional motifs: dragons, carps, samurai, flowers in bright, rich colors.",
            service_chicano_title: "Chicano",
            service_chicano_desc: "Gangster themes, religious and cultural symbols, usually in black and gray.",
            service_ornamental_title: "Ornamental",
            service_ornamental_desc: "Geometric patterns, mandalas, ethnic motifs creating unique designs.",
            service_mini_tattoo_title: "Mini Tattoo",
            service_mini_tattoo_desc: "Small, neat tattoos with deep meaning or just for decoration.",
            portfolio_title: "My Works",
            process_title: "Process",
            process_consultation_title: "Consultation",
            process_consultation_desc: "Discuss your ideas, style, size, and placement of the future tattoo. Your vision is our priority.",
            process_design_title: "Design Development",
            process_design_desc: "Creating a unique sketch that perfectly suits you, considering all wishes and anatomical features.",
            process_preparation_title: "Preparation",
            process_preparation_desc: "Preparing the skin and workspace, ensuring full sterility and your comfort.",
            process_tattooing_title: "Tattooing",
            process_tattooing_desc: "Carefully and professionally applying the tattoo, paying attention to every detail for a perfect result.",
            process_aftercare_title: "Aftercare",
            process_aftercare_desc: "Providing detailed recommendations for caring for your new tattoo so it pleases you for many years.",
        ...
        uk: {
            ...
            hero_description: "Кирило – ваш майстер ексклюзивних татуювань у Німеччині. Спеціалізуюся на реалістичних, японських, чикано, орнаментальних та міні-тату. Створюю унікальні твори мистецтва на вашій шкірі, що відображають вашу індивідуальність та стиль. Моя робота — це не просто нанесення чорнил, а створення історії, яка залишиться з вами назавжди. Висока якість, увага до деталей та стерильність – мої головні пріоритети.",
            ...
            process_consultation_desc: "Обговорюємо ваші ідеї, стиль, розмір та розташування майбутньої татуювання. Ваше бачення - наш пріоритет.",
            ...
            process_preparation_desc: "Підготовлюємо шкіру та робоче місце, забезпечуючи повну стерильність та ваш комфорт.",
            ...
            process_aftercare_desc: "Надаємо докладні рекомендації щодо догляду за новою татуюванням, щоб вона радувала вас довгі роки.",
        ...
        de: {
            ...
            service_japanese_desc: "Traditionelle Motive: Drachen, Karpfen, Samurai, Blumen in leuchtenden, satten Farben.",
            service_chicano_title: "Chicano",
            service_chicano_desc: "Gangsterthemen, religiöse und kulturelle Symbole, meist in Schwarz-Weiß.",
            service_ornamental_title: "Ornamental",
            service_ornamental_desc: "Geometrische Muster, Mandalas, ethnische Motive, die einzigartige Designs schaffen.",
            service_mini_tattoo_title: "Mini-Tattoo",
            service_mini_tattoo_desc: "Kleine, saubere Tattoos mit tiefer Bedeutung oder einfach zur Dekoration.",
            portfolio_title: "Meine Arbeiten",
            process_title: "Prozess",
            process_consultation_title: "Beratung",
            process_consultation_desc: "Wir besprechen Ihre Ideen, Stil, Größe und Platzierung des zukünftigen Tattoos. Ihre Vision ist unsere Priorität.",
            ...
            process_preparation_desc: "Wir bereiten die Haut und den Arbeitsplatz vor und sorgen für vollständige Sterilität und Ihren Komfort.",
            process_tattooing_title: "Tätowierung",
            process_tattooing_desc: "Wir tätowieren sorgfältig und professionell und achten auf jedes Detail für ein perfektes Ergebnis.",
            process_aftercare_title: "Nachsorge",
            process_aftercare_desc: "Wir geben detaillierte Empfehlungen zur Pflege Ihres neuen Tattoos, damit es Sie viele Jahre erfreut.",
